...
local mappings = {
  ...
  ["["] = {
      name = "Previous...",
      c = { "<cmd>ConflictMarkerPrevHunk<bar>normal z.<cr>",              "Previous Conflict" },
      d = { "<cmd>lua vim.diagnostic.goto_prev()<bar>normal z.<cr>",      "Previous Diagnostic" },
      h = { "<cmd>Gitsigns prev_hunk<bar>normal z.<cr>",                  "Previous Git Hunk" },
      l = { "<cmd>lprevious<bar>normal z.<cr>",                           "Previous Location List" },
      q = { "<cmd>cprevious<bar>normal z.<cr>",                           "Previous Quickfix" },
  },
  ["]"] = {
      name = "Next...",
      c = { "<cmd>ConflictMarkerNextHunk<bar>normal z.<cr>",              "Next Conflict" },
      d = { "<cmd>lua vim.diagnostic.goto_next()<bar>normal z.<cr>",      "Next Diagnostic" },
      h = { "<cmd>Gitsigns next_hunk<bar>normal z.<cr>",                  "Next Git Hunk" },
  ...
  ["<leader>"] = {
    ...
    d = {
      ...
      s = { "<cmd>lua require('diagnostic-window').show()<cr>", "Show Line Diagnostics in Split" },
